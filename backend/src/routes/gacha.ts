...
// Gacha probabilities (모든 팩 아이콘 확률 0.00005% 통일 - 더더더 낮춤)
const GACHA_OPTIONS = {
  free: { cost: 0, probabilities: { icon: 0.00005, legendary: 0.01995, epic: 0.1, rare: 5, common: 94.88 } },
  basic: { cost: 500, probabilities: { icon: 0.00005, legendary: 0.05995, epic: 0.5, rare: 10, common: 89.44 } },
  premium: { cost: 1000, probabilities: { icon: 0.00005, legendary: 0.21995, epic: 3, rare: 18, common: 78.78 } },
  ultra: { cost: 1500, probabilities: { icon: 0.00005, legendary: 0.51995, epic: 6, rare: 25, common: 68.48 } },
  mega: { cost: 2000, probabilities: { icon: 0.00005, legendary: 1.01995, epic: 10, rare: 30, common: 58.98 } },
  worlds_winner: { cost: 2500, probabilities: { icon: 0.00005, legendary: 5.00995, epic: 25, rare: 69.99, common: 0 }, special: 'WORLDS' }, // 25WW, 25WUD, and Rare+ cards (레어 이상 확정)
