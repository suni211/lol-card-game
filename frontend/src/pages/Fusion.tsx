          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-1 text-sm text-blue-800 dark:text-blue-200">
                ...
                <li>• 합산 오버롤 500 이상: 에픽/레전드 (90% 에픽, 10% 레전드)</li>
                <li>• 합산 오버롤 475-499: 레어/에픽 (80% 레어, 20% 에픽)</li>
                <li>• 합산 오버롤 450-474: 일반/레어 (70% 일반, 30% 레어)</li>
                <li>• 합산 오버롤 425-449: 일반/레어 (85% 일반, 15% 레어)</li>
                <li>• 합산 오버롤 425 미만: 일반 확정</li>
