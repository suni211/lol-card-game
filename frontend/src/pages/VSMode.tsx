...
export default function VSMode() {
  ...
  const stage2 = { num: 2, name: '2단계', boss: false, pts: 200, enemies: ['Rich (73)', 'Sponge (71)', 'kyeahoo (70)', 'Teddy (79)', 'Andil (81)'], enemiesHard: ['Rich (76)', 'Sponge (74)', 'kyeahoo (73)', 'Teddy (82)', 'Andil (84)'] };
  const stage3 = { num: 3, name: '3단계 - 중간보스', boss: true, pts: 1000, enemies: ['Morgan (83)', 'Croco (76)', 'Clozer (90)', 'Hype (75)', 'Pollu (74)'], enemiesHard: ['Morgan (86)', 'Croco (79)', 'Clozer (91)', 'Hype (78)', 'Pollu (77)'] };
  ...
  const stage5 = { num: 5, name: '5단계', boss: false, pts: 3000, enemies: ['Siwoo (83)', 'Lucid (86)', 'ShowMaker (88)', 'Aiming (83)', 'BeryL (85)'], enemiesHard: ['Siwoo (88)', 'Lucid (91)', 'ShowMaker (95)', 'Aiming (90)', 'BeryL (92)'] };
  ...
  const stage8 = { num: 8, name: '8단계', boss: false, pts: 5000, enemies: ['Zeus (99)', 'Peanut (91)', 'Zeka (89)', 'Viper (97)', 'Delight (86)'], enemiesHard: ['Zeus (107)', 'Peanut (99)', 'Zeka (97)', 'Viper (105)', 'Delight (94)'] };
