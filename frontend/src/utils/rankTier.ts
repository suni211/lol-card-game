...
// 티어 배경 색상 (단색)
export function getRankTierBgColor(tier: string): string {
  switch (tier) {
    case 'CHALLENGER':
    ...
    case 'PLATINUM':
      return 'bg-gradient-to-r from-teal-400 via-cyan-500 to-teal-600';
    case 'GOLD':
    ...
    case 'BRONZE':
      return 'bg-gradient-to-r from-orange-600 via-orange-700 to-orange-800';
    default:
